...
public class Salesman extends javax.swing.JFrame {
    ...
    public void salesmanList()
    {
        int count;
        try {
            pst = con.prepareStatement("SELECT * FROM salesman_table");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        txtSalesmanName = new javax.swing.JTextField();
        ...
        jLabel1.setText("MANAGE SALESMAN");
        ...
        txtSalesmanName.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        if (CustomerListTable.getColumnModel().getColumnCount() > 0) {
            CustomerListTable.getColumnModel().getColumn(0).setPreferredWidth(40);
            CustomerListTable.getColumnModel().getColumn(0).setMaxWidth(40);
            CustomerListTable.getColumnModel().getColumn(3).setPreferredWidth(50);
        }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtSalesmanName, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                                    .addComponent(txtContact, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtSalesmanName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(27, 27, 27)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            pst = con.prepareStatement("INSERT INTO salesman_table(name,contact,email) VALUES(?,?,?)");
    ...
    private void CustomerListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CustomerListTableMouseClicked
        ...
        DefaultTableModel d1 = (DefaultTableModel)CustomerListTable.getModel();
        int selectIndex = CustomerListTable.getSelectedRow();
        
        int id = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
        txtSalesmanName.setText(d1.getValueAt(selectIndex, 1).toString());
   ...
   // TODO add your handling code here:
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            pst = con.prepareStatement("UPDATE salesman_table SET name = ?, contact = ?, email = ? WHERE id = ?");
            pst.setString(1, name);
            pst.setString(2, contact);
            pst.setString(3, email);
            pst.setInt(4, id);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            pst = con.prepareStatement("DELETE FROM salesman_table WHERE id = ?");
            pst.setInt(1, id);
            int result = pst.executeUpdate();
    ...
    private javax.swing.JTextField txtSalesmanName;
