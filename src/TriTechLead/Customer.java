...
public class Customer extends javax.swing.JFrame {
    ...
    public void customerList()
    {
        int count;
        try {
            pst = con.prepareStatement("SELECT * FROM customer_table");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        txtCustomerName.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        CustomerListTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Contact", "Timestamp"
            }
        ) {
        ...
        if (CustomerListTable.getColumnModel().getColumnCount() > 0) {
            ...
            CustomerListTable.getColumnModel().getColumn(4).setPreferredWidth(50);
        }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtCustomerName, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
   ...
   // TODO add your handling code here:
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            pst = con.prepareStatement("UPDATE customer_table SET customerName = ?, contact = ?, email = ? WHERE id = ?");
            pst.setString(1, customerName);
            pst.setString(2, contact);
            pst.setString(3, email);
            pst.setInt(4, id);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            pst = con.prepareStatement("DELETE FROM customer_table WHERE id = ?");
            pst.setInt(1, id);
            int result = pst.executeUpdate();
